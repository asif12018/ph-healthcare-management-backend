/*
  ...
  - You are about to drop the column `aerageRating` on the `doctor` table. All the data in the column will be lost.
  - You are about to drop the column `deleteddAt` on the `doctor` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "doctor" DROP COLUMN "aerageRating",
DROP COLUMN "deleteddAt",
